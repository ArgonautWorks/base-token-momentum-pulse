...
// The Payan relay intentionally pins a harmless discovery query in its external URL;
// direct resolver receipts continue to identify the bare API endpoint above.
export const RESOLVER_RELAY_ENDPOINT = "https://argonaut-base-token-momentum-pulse.vercel.app/api/v1/resolve?query=token";
