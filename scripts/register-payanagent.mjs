...
const momentum = await syncRelayOffer({
  ...
  priceUsd: 0.004,
  metadata: {
    title: "Trending Base Tokens — USDC Volume & Buy/Sell Activity",
    description: "Find trending Base tokens in a sealed 300-block validated onchain snapshot. Ranks exact native-USDC DEX volume and returns swaps, unique transactions, buy/sell activity, onchain token metadata, approved pool/factory evidence, and Base Blockscout links. Free representative output: https://argonaut-base-token-momentum-pulse.vercel.app/sample. No safety, quality, return, or investment judgment.",
    category: "Data",
    tags: ["trending-base-tokens", "base-token-data", "dex-volume", "usdc-volume", "buy-sell-activity", "onchain", "blockscout"],
    offerType: "api",
    httpMethod: "GET",
